...
//    }
    ...
    public boolean isDaoHan() {
        ...
        boolean b3 = (d.get(Calendar.DAY_OF_YEAR) == this.ngayDaoHan.get(Calendar.DAY_OF_YEAR));
        return b1 && b2 && b3;
    }
    ...
    public String toString() {
        return String.format("%sKy han: %s\nNgay dao han: %s\n", 
                super.toString(), this.kyHan.toString(),
                this.f.format(this.ngayDaoHan.getTime())); //To change body of generated methods, choose Tools | Templates.
    }
